                ...
                <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text"  name="person_incharge" class="form-control @error('person_incharge') is-invalid @enderror" value="{{old('person_incharge')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="email"  name="email1" class="form-control @error('email1') is-invalid @enderror" value="{{old('email1')}}" placeholder="enter email for account">
                                @error('email1')
                                    <span class="text-danger"> {{$message}}  </span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text"  name="membership_with_other_auctioneers" class="form-control @error('membership_with_other_auctioneers') is-invalid @enderror" value="{{old('membership_with_other_auctioneers')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text"  name="antique_license" id="antique_license"  class="form-control @error('antique_license') is-invalid @enderror" value="{{old('antique_license')}}" autocomplete="off">
