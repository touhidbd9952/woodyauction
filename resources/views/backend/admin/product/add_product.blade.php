        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    Product Add Form
                    <a href="{{route('product.view_unsold')}}"  style="float: right;">View Product</a>
                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select name="woner_id" id="wonerList" autocomplete="off" class="form-control @error('woner_id') is-invalid @enderror" required>
                                    ...
                                    <option value="{{$woner->id}}">{{ $woner->name_en }}&nbsp;==>,Company:&nbsp;{{ $woner->company_name_en }}&nbsp;,ID:&nbsp;{{ $woner->usercodeno }}&nbsp;,phone:&nbsp;{{ $woner->phone1 }}</option>
                                    @endforeach
                                </select>
                                if not exist, click on <a href="{{route('owner.add_form')}}" onclick="return confirm('Are you shure want to add new owner. Before leave this page, Please save informaton in draft')">Add New</a>
