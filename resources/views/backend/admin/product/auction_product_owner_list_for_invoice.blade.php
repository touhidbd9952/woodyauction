                        ...
                        <table id="example2" class="table table-striped table-bordered">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>{{ $d->phone1 }}</td>
                                    <td>
                                        <a href="{{url('auction/product_owner_invoice/'. $sl.'/'.$d->id.'/'.$enddate)}}" class="btn btn-success">Generate Invoice</a>
                                        ...
                                        ?>
                                            @foreach($infoservicelist as $info)
                                                <?php 
                                                if($info->owner_id == $d->id)
                                                {
                                                    $c=1;
                                            ?>     
                                                <a href="{{url('infoservice/add_owner_service/1/'.$auction_id.'/'.$d->id.'/'.$enddate)}}" onclick="return confirm('Are you shure want to update this activity')" class="btn btn-default">
                                                ...
                                                <a href="{{url('infoservice/add_owner_service/2/'.$auction_id.'/'.$d->id.'/'.$enddate)}}" onclick="return confirm('Are you shure want to update this activity')" class="btn btn-default">
                                                ...
                                                <a href="{{url('infoservice/add_owner_service/3/'.$auction_id.'/'.$d->id.'/'.$enddate)}}" onclick="return confirm('Are you shure want to update this activity')" class="btn btn-default">
