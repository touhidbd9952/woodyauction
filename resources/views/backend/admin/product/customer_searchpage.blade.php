                        ...
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Customer Search Form</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('auction.get_maximum_bidder_list')}}" method="post" enctype="multipart/form-data">
                        @csrf
