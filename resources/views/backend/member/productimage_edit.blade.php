        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{url('member_product/imageview/'.$productimagedata->product_id)}}"    style="float: right;">Back</a>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form name="myform" action="{{url('member_productimage/update/'.$productimagedata->id)}}"  method="POST" enctype="multipart/form-data" class="form-horizontal">
