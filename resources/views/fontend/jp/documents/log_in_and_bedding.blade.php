            ...
            <div id="menudiv2" class="col-md-12" > 
                ...
                <p>
                    ...
                    <li>
                        ...
                        <br>
                        <img src="{{url('fontend/images/document/login.jpg')}}" style="max-width:700px;">
                    </li>
                </p>
                ...
                <p>
                    ...
                    <li>
                        ...
                        <br>
                        <img src="{{url('fontend/images/document/bidding.jpg')}}" style="max-width:700px;">
                    </li>
                </p>
                ...
                <p>
                    ...
                    <li>
                        ...
                        <br>
                        <img src="{{url('fontend/images/document/bidconfirm.jpg')}}" style="max-width:700px;">
                        <br><br>
                    </li>
                </p>
                ...
                <p>
                    ...
                    <li>
                        ...
                        <br>
                        <img src="{{url('fontend/images/document/bidstatus.jpg')}}" style="max-width:700px;">
                    </li>
                </p>
                ...
                <p>
                    ...
                    <li>
                        ...
                        <br>
                        <img src="{{url('fontend/images/document/winbidmessage.jpg')}}" style="max-width:700px;">
                    </li>
                </p>
                ...
                <p>
                    ...
                    <li>
                        ...
                        <br>
                        <img src="{{url('fontend/images/document/losebidmessage.jpg')}}" style="max-width:700px;">
                    </li>
                </p>
