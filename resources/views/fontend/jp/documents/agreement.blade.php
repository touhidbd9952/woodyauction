        ...
        <div class="row"> 
            <div class="col-md-12"> 
                <div style="width: 100%;min-height:50px;">
                    <div class="col-md-3">
                        <a href="javascript:" class="menudiv" onclick="showmenu('menudiv1')">Terms and Condition</a>
                    </div>
                    <div class="col-md-3">
                        <a href="javascript:" class="menudiv" onclick="showmenu('menudiv2')">Security Deposit</a>
                    </div>
                    <div class="col-md-3">
                        <a href="javascript:" class="menudiv" onclick="showmenu('menudiv3')">Winner Bidding to Payment</a>
                    </div>
                    <div class="col-md-3">
