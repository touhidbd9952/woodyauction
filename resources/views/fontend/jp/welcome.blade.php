                  ...
                  <ul class="list-group">
                    <li class="list-group-item yellow">
                        <a href="{{route('woody.auction')}}">
                          <i class="fas fa-angle-double-right"></i> ウッディーオークション<span></span></a>
                    </li>
                    <li class="list-group-item yellow-color">
                      <a href="{{route('woody.bid_document')}}"><i class="fas fa-angle-double-right"></i>入札案内</a>
                    </li>
                    {{-- <li class="list-group-item yellow-color">
                      <a href="{{route('product_owner.product_owner_register')}}">Product Owner Registration</a>
                    </li> --}}
                    <li class="list-group-item yellow-color">
                      <a href="{{route('bid_document.bidding_style')}}"><i class="fas fa-angle-double-right"></i>オークションの流れ</a>
                    </li>
                    <li class="list-group-item yellow-color">
                      <a href="{{route('member.register')}}"><i class="fas fa-angle-double-right"></i>入札者会員登録</a>
                    </li>
                  </ul>
                </div>  
            </div>    
            <div class="col-md-6">
                ...
                <ul class="list-group">
                    <li class="list-group-item red">
                        <a href="{{route('woody.search_site')}}">
                          <i class="fas fa-angle-double-right"></i> ウッディーオークション結果検索サイト<span></span>
                        </a>
                    </li>
        ...
        <div class="col-md-6">
            ...
            <ul class="list-group">
                <li class="list-group-item green">
                    <a href="{{url('/guidebook')}}"><i class="fas fa-angle-double-right"></i> Woody Auction Features<span></span></a>
                </li>
        ...
        <div class="col-md-6">
            ...
            <ul class="list-group">
                <li class="list-group-item blue">
                    <a href="javascript:"><i class="fas fa-angle-double-right"></i> サポート<span></span></a>
                </li>
