                    ...
                    <thead class="thead-dark">
                        <thead  class="thead-dark">
                            <tr class="table-secondary">
                                <th class="headercolor" style="width:30%">名前</th>
                                <th class="headercolor" style="width:20%">会社名</th>
                                <th class="headercolor" style="width:20%">国</th>
                                <th class="headercolor" style="width:20%">理由</th>
                            </tr>
                        </thead>
                    </thead>
